...
import { DemoJVectorMapPanel } from "./map/demo-jvectormap/DemoJvectorMap.panel";
import { DemoLeafletPanel } from "./map/demo-leaflet/DemoMapLeaflet.panel";
import { DemoSimpleMapPanel } from "./map/demo-simplemap/DemoSimpleMap.panel";
...
export const DemoMainPanel = (): JSX.Element => {
  ...
  const [activeMapMenu, setActiveMapMenu] = useState<boolean>(false);
          ...
          <div className="col">
            <Card>
                ...
                <Row>
                  ...
                  <Col lg="11" className="d-flex flex-column justify-content-end">
                    <FormGroup>
                      ...
                      <Dropdown
                        isOpen={activeMapMenu}
                        toggle={() => setActiveMapMenu(!activeMapMenu)}
                      >
                        <DropdownToggle
                          caret
                          color="primary"
                        ...
                        <DropdownMenu>
                          <DropdownItem
                            className={`font-weight-bold ${
                              activeTab == DEMO_JVECTOR_MAP ? "bg-lighter" : ""
                            }`}
                            onClick={() => setActiveTab(DEMO_JVECTOR_MAP)}
                          >
                            JVector Map
                          </DropdownItem>
                          <DropdownItem
                            className={`font-weight-bold ${
                              activeTab == DEMO_LEAFLET_MAP ? "bg-lighter" : ""
                            }`}
                            onClick={() => setActiveTab(DEMO_LEAFLET_MAP)}
                          >
                            Leaflet
                          </DropdownItem>
                          <DropdownItem
                            className={`font-weight-bold ${
                              activeTab == DEMO_SIMPLE_MAP ? "bg-lighter" : ""
                            }`}
                            onClick={() => setActiveTab(DEMO_SIMPLE_MAP)}
                          >
                            Simple Map
                          </DropdownItem>
                        </DropdownMenu>
              ...
              <TabContent activeTab={activeTab}>
                ...
                <TabPane tabId={DEMO_JVECTOR_MAP}>
                  <DemoJVectorMapPanel />
                </TabPane>
                <TabPane tabId={DEMO_LEAFLET_MAP}>
                  <DemoLeafletPanel />
                </TabPane>
                <TabPane tabId={DEMO_SIMPLE_MAP}>
                  <DemoSimpleMapPanel setTooltipContent={setContent} />
